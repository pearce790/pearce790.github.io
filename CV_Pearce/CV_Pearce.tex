...
\textbf{Pearce, M.} and Zhou, S. (2025) ``RaCE: a Rank-Clustering Estimation Method for Network Meta-Analysis." \textit{Research Synthesis Methods} 17.2: 314--31.

\textbf{Pearce, M.} and Erosheva, E.A. (2025) ``Bayesian Rank-Clustering" \textit{Psychometrika} 90.3: 904--931.
...
\textbf{Pearce, M.} and Erosheva, E.A. (2025) ``Modeling Preferences: A Bayesian Mixture of Finite Mixtures for Rankings and Ratings" \textit{Journal of the American Statistical Association} 120.551: 1621--1632.

Gallo, S.A., \textbf{Pearce, M.}, Lee, C.J., and Erosheva, E.A. (2023) ``A new approach to peer review assessments: Score, then rank." \textit{Research Integrity and Peer Review} 8.10.
...
\begin{enumerate}
\item ``Rank-clustering treatments in network meta-analyses of clinical trials data" \textit{Oregon Chapter of the ASA Fall Meeting}, Portland, OR, November 2026 (\textit{Invited})
\item ``Bayesian Rank-Clustering" \textit{15th Scientific Meeting Classification and Data Analysis Group}, Naples, IT, September 2025 (\textit{Invited session}).
...
\item Co-organizer, Math and Statistics graduate school panel (2023, 2024, 2025)
...
\begin{itemize}
\item Anonymous peer reviewer ({\it PlosOne, Biomedicine Hub, Cogent Social Sciences, Advances in Data Science and Classification, Journal of Statistics and Data Science Education, Journal of Open Research Software, Annals of Applied Statistics})
\item Member, Scientific organizing committee for the Classification Society Annual Meeting (2026)
\item Judge, Undergraduate Statistics Project Competition (December 2023 and 2025 cycles)
...
\textbf{RaCE.NMA: Rank-Clustering Estimation of treatments in a Network Meta-Analysis.} R package available on Github. Vignettes available \href{https://pearce790.github.io/RaCE.NMA/}{here}.
