...
\address{https://pearce790.github.io/; michaelpearce@reed.edu} % Your phone number and email
...
\item Co-organizer, graduate school panel (2023)
\end{itemize}

\textit{College-wide committees:}
\begin{itemize}
\item Statistics tenure-track search (2023, 2024 spring, 2024 fall)
\item Statistics visiting search (2024 spring)
\item Undergraduate research (2023--24)
\end{itemize}
...
\begin{itemize}
\item Anonymous peer review ({\it PlosOne, Biomedicine Hub, Cogent Social Sciences, Advances in Data Science and Classification})
\item Undergraduate Statistics Project Competition (USPROC) Judge (Spring 2024)
