...
\textbf{Pearce, M.} and Perlman, M. (2025) ``Estimating the ratio of means in a zero-inflated Poisson mixture model" \textit{Stats} (\textit{accepted}).

\textbf{Pearce, M.} and Erosheva, E.A. (2025) ``Bayesian Rank-Clustering" \textit{Psychometrika} (\textit{accepted}).

\textbf{Pearce, M.} and Erosheva, E.A. (2025) ``Modeling Preferences: A Bayesian Mixture of Finite Mixtures for Rankings and Ratings" \textit{Journal of the American Statistical Association} (accepted).
